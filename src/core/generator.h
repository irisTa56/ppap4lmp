...
/*!
  ...
  An UpdatePair instance is created only in Element::append_updater.
*/
...
/*!
  ...
  subclasses, GenDict and GenList class, one can group Element instances
  in one Generator instance and control all the updating process.
*/
class Generator {
 protected:
  /*!
    ...
    one by the #hello. In this updating process, the Element instances
    (the first items of ::UpdatePair) uses the Updater instances (the
  ...
  */
  ...
  /*!
    ...
    #update_chain.
    @param new_chain : A chain of ::UpdatePair instances to be merged.
    @return None.
  ...
  */
  virtual ShPtr<Generator> get_generator(
    const Json &name = nullptr) = 0;
  /*!
    @brief Appoint to this instance.
    @return None.
  ...
  */
  void appoint();
  /*!
    @brief Hello to this instance.
    @return None.
    @details Greeting means calling Element::update_data for all
    the ::UpdatePair instances in the #update_chain, that is, executing
    the updating process associated with this instance. By executing
    this method, Element::data in this Element instance (or Element
    instances in this GenDict or GenList instance) is set (filled with
    values).
  */
  void hello();
  /*!
    @brief Goodbye to this instance.
    @return None.
