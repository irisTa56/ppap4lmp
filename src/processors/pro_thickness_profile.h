...
/*!
  ...
  for the \e x and \e y direction, respectively.
  The thickness is measured in the \e z direction.
  ...
  \e z coordinate inside excluded volume of any of the particles.
...
class ProThicknessProfile : public Processor {
  /*!
    The number of grids in \e x direction.
  */
  int nx = 1;
  /*!
    The number of grids in \e y direction.
  */
  int ny = 1;
  /*!
    Whether to shift grids at which film thickness is computed.
    If this member is \c false, grids in the \e x direction are set as
    <i>x_0, x_0+dx, x_0+2*dx, ..., x_0+(#nx-1)*dx</i>,
    where \e x_0 is the minimum \e x coordinate in the simulation box
    and \e dx is the grid width.
    If this member is \c true, grids in the \e x direction are set as
  ...
  */
  ...
  /*!
    ...
    from \e z coordinate of the particles. Default is 0.
  */
  double offset = 0.0;
  /*!
 ...
 public:
  /*!
    ...
    <span class="remove_in_table">
      A GenDict object is constructed taking the \c atoms and \c box,
  ...
  */
  ...
  /*!
    @brief Specify the number of grids in the \e x and \e y directions.

    @param nx_
      The number of grids in the \e x direction.
      <span class="remove_in_table">
        This parameter is assigned to #nx.
      </span>

    @param ny_
      The number of grids in the \e y direction.
      <span class="remove_in_table">
  ...
  */
  ...
  /*!
    ...
    the grid width. By default, grids in the \e x direction are
    set as <i>x_0, x_0+dx, x_0+2*dx, ... </i>, where \e x_0 is
    the minimum \e x coordinate in the simulation box and \e dx is
